...
> **Phase 11.3 — 지수선물옵션 + 상품선물 실시간 6 WS (v1.23.0). 누적 130 REST + 34 WS = 164 endpoints.**
...
> 국내선물옵션 시세 (REST): Phase 11.1 (v1.21.0) — 9 EP. 선물옵션 Phase 11.4 Trading + 체결통보 AES256 → Phase 11.4+.
