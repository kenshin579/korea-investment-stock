...
- Phase 11.6: schemas reference at `overseasfutures/testdata/_schemas_phase11_6.md` (lightweight, 11.5 sub-package 확장)
- Phase 11.7: schemas reference at `websocket/testdata/_schemas_phase11_7.md` (lightweight, 해외선물옵션 실시간 2 EP)
...
> Phase 11.4 Trading / 11.8 해외 Trading / 체결통보 AES256 → 후속.
