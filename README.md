...
- ✅ 실시간 WebSocket — KRX 5 EP (Phase 8; v1.18.0) + NXT/통합 10 EP (Phase 9; v1.19.0) + 해외 시세 2 EP (Phase 10; v1.20.0) + 국내선물옵션 11 EP (Phase 11.2; v1.22.0) + 지수선물옵션+상품선물 6 EP (Phase 11.3; v1.23.0)
