...
output | 응답상세 | Object | Y |  | **실측 노트(2026-08-05): 문서상 Type 은 Object 이나 실제 응답의 output 은 배열(Array)로 내려온다. SDK(domestic/investor.go)는 []InvestorTimeByMarketSnapshot 로 파싱한다.**  
